export default {
  ...
  home: {
    ...
    why: {
      ...
      description: 'LuckPerms 是Minecraft服务器的权限插件。它允许服务器管理员通过创建组和分配权限来控制玩家可以使用的功能。',
      its: '其具有的优势:',
    ...
    wiki: '了解如何安装、设置、配置和高效地利用LuckPerms',
    github: '浏览源代码，报告问题并为项目做出贡献',
    discord: '与 {count} 名其他用户一道讨论插件或进行提问与解答',
    patreon: '与 {count} 名用户一同在 Patreon 上用金钱支撑起LuckPerms的未来',
    partner: {
      title: '主机商合作通道',
  ...
  download: {
    ...
    trouble: {
      ...
      read: '在 {wiki} wiki页面查看您是否需要执行进一步的操作。',
      wiki: '安装',
  ...
  quiz: {
    ...
    older: '{version} 或更旧',
    newer: '{version} 或以上',
    result: '您仅需要 LuckPerms 正式版就能安装于 {serverType}',
    resultLegacy: '您需要 LuckPerms Legacy 才能安装于 {serverType}',
